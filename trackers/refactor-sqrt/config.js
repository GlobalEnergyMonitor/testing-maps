var config = {
    ...
    tableHeaders: {
        values: ['name','unit-name','name-(local)','owner', 'parent', 'capacity-(mw)', 'status', 'start-year', 'retired-year', 'region', 'country/area', 'subnational-unit-(province,-state)'],
    ...
    */
    detailView: {
        ...
        // 'name-(local)': {'label': 'Local plant name'},
        // 'owner': {'label': 'Owner'},
        // 'parent': {'label': 'Parent'},
